...
const Footer: React.FC = () => {
  ...
  const cloudServices = [
    ...
    { path: '/services/infrastructure-management', label: 'Infrastructure Management' }
  ];
  ...
  return (
    <footer className={`${
      theme === 'dark' ? 'bg-dark-surface text-dark-text' : 'bg-gray-100 text-gray-900'
    } py-12`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className={`mt-4 text-sm ${
              ...
              Leading provider of cloud solutions and digital transformation services.
            </p>
          </div>
        ...
        <div className={`mt-8 pt-8 ${
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-center">
              &copy; {new Date().getFullYear()} ACEDEMAND IT Consulting Services. All rights reserved.
            </p>
          </div>
        </div>
      </div>
